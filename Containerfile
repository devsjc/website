# -- Compile Busybox with only HTTPD -- #
...
RUN du -h -d0 /busybox/_install/bin/busybox
...
COPY --from=bundler /dist /home/static

COPY <<EOF /home/static/httpd.conf
EOF
