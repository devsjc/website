...
Now, clearly a competitive salary, generous leave, good benefits, and plenty of socials would be the main ways to achieve this - but that's not the part of developer happiness I'm talking about to here. Since developers spend most of their working hours _developing_ - writing, reviewing, deploying, testing code - a large part of achieving that _keep them happy_ priority comes from making sure that their development process is as frictionless as it can be. And here is where **code quality** plays its part.
